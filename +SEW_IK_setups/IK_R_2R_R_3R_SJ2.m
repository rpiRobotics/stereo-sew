classdef IK_R_2R_R_3R_SJ2
    methods (Static)
        function [P, S] = setup()
            ...
            P.kin.P = [rand_vec rand_vec zv rand_vec rand_vec zv zv rand_vec];
            P.kin.H = rand_normal_vec(7);

            [P.R, P.T, P_SEW] = fwdkin_inter(P.kin, S.Q, [2 4 5]);
        ...
        function S = run_mex(P)
            [S.Q, S.is_LS] = SEW_IK.IK_R_2R_R_3R_SJ2_mex(P.R, P.T, P.sew, P.psi, P.kin);
        end

        function generate_mex()
            P = SEW_IK_setups.IK_R_2R_R_3R_SJ2.setup(); %#ok<NASGU> 
            codegen -report +SEW_IK/IK_R_2R_R_3R_SJ2.m -args {P.R, P.T, P.sew, P.psi, P.kin}
        end
