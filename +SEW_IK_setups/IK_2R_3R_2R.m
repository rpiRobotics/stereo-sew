classdef IK_2R_3R_2R
    methods (Static)
        function [P, S] = setup()
            ...
            P.kin.P = [rand_vec zv rand_vec zv zv rand_vec zv rand_vec];
        ...
        function S = run_mex(P)
            [S.Q, S.is_LS] = SEW_IK.IK_2R_3R_2R_mex(P.R, P.T, P.sew, P.psi, P.kin);
        end

        function generate_mex()
            P = SEW_IK_setups.IK_2R_3R_2R.setup(); %#ok<NASGU> 
            codegen -report +SEW_IK/IK_2R_3R_2R.m -args {P.R, P.T, P.sew, P.psi, P.kin}
        end
