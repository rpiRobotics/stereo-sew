classdef IK_gen_7_dof
    methods (Static)
        ...
        function S = run(P)
            [S.Q, S.is_LS] = SEW_IK.IK_gen_7_dof(P.R, P.T, P.sew, P.psi, P.kin);
        end

        function S = run_mex(P)
            [S.Q, S.is_LS] = SEW_IK.IK_gen_7_dof_mex(P.R, P.T, P.sew, P.psi, P.kin);
        end

        function generate_mex()
            P = SEW_IK_setups.IK_gen_7_dof.setup(); %#ok<NASGU> 
            codegen -report +SEW_IK/IK_gen_7_dof.m -args {P.R, P.T, P.sew, P.psi, P.kin}
        end
