classdef IK_R_R_3Rp_2R
    methods (Static)
        function [P, S] = setup()
            ...
            P.kin.P = [rand_vec rand_vec rand_vec rand_vec rand_vec rand_vec zv rand_vec];
        ...
        function S = run(P)
            [S.Q, S.is_LS] = SEW_IK.IK_R_R_3Rp_2R(P.R, P.T, P.sew, P.psi, P.kin);
        end

        function S = run_mex(P)
            [S.Q, S.is_LS] = SEW_IK.IK_R_R_3Rp_2R_mex(P.R, P.T, P.sew, P.psi, P.kin);
        end

        function generate_mex()
            P = SEW_IK_setups.IK_R_R_3Rp_2R.setup(); %#ok<NASGU> 
            codegen -report +SEW_IK/IK_R_R_3Rp_2R.m -args {P.R, P.T, P.sew, P.psi, P.kin}
        end
